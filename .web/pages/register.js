...
export function Root_c227a4d41b7d624f3dae23e586ccc438 () {
  ...
  const ref_confirm_password = useRef(null); refs["ref_confirm_password"] = ref_confirm_password;
    ...
    const handleSubmit_391dc2223c577568c4a6f39144146e82 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["username"] : getRefValue(refs["ref_username"]), ["password"] : getRefValue(refs["ref_password"]), ["mail"] : getRefValue(refs["ref_mail"]), ["confirm_password"] : getRefValue(refs["ref_confirm_password"]) })};
  ...
  return (
    <RadixFormRoot className={"Root "} css={({ ["width"] : "100%", ["margin-top"] : "10%" })} onSubmit={handleSubmit_391dc2223c577568c4a6f39144146e82}>
...
export function Errorboundary_53e11cafa469b3bdd421a9f70282ea22 () {
...
<Root_c227a4d41b7d624f3dae23e586ccc438/>
</RadixThemesBox>
</RadixThemesBox>
...
export default function Component() {
  ...
  return (
    <Errorboundary_53e11cafa469b3bdd421a9f70282ea22/>
  )
}
