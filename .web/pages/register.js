...
export function Root_9869518e7de7da05c22e04ba8fd23a5a () {
  ...
  const ref_confirm_password = useRef(null); refs["ref_confirm_password"] = ref_confirm_password;
    ...
    const handleSubmit_345d98a821eb83d3280d24b9c5970169 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["password"] : getRefValue(refs["ref_password"]), ["phone"] : getRefValue(refs["ref_phone"]), ["mail"] : getRefValue(refs["ref_mail"]), ["confirm_password"] : getRefValue(refs["ref_confirm_password"]), ["username"] : getRefValue(refs["ref_username"]) })};
  ...
  return (
    <RadixFormRoot className={"Root "} css={({ ["width"] : "100%", ["margin-top"] : "10%" })} onSubmit={handleSubmit_345d98a821eb83d3280d24b9c5970169}>
...
export function Errorboundary_5fa8b14fd32aa9ece0c6ed8030d7ec31 () {
...
<Root_9869518e7de7da05c22e04ba8fd23a5a/>
</RadixThemesBox>
</RadixThemesBox>
...
export default function Component() {
  ...
  return (
    <Errorboundary_5fa8b14fd32aa9ece0c6ed8030d7ec31/>
  )
}
