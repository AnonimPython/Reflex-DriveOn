...
export function Root_d96a4c5c90cb64275ce1b63132467648 () {
  ...
  const ref_confirm_password = useRef(null); refs["ref_confirm_password"] = ref_confirm_password;
    ...
    const handleSubmit_7fe4c5a01bd629b643e9843087dc7bb0 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["confirm_password"] : getRefValue(refs["ref_confirm_password"]), ["password"] : getRefValue(refs["ref_password"]), ["phone"] : getRefValue(refs["ref_phone"]), ["username"] : getRefValue(refs["ref_username"]), ["mail"] : getRefValue(refs["ref_mail"]) })};
  ...
  return (
    <RadixFormRoot className={"Root "} css={({ ["width"] : "100%", ["margin-top"] : "10%" })} onSubmit={handleSubmit_7fe4c5a01bd629b643e9843087dc7bb0}>
...
export function Errorboundary_2e2602e2f7ba03eac0fee461bf67b16c () {
...
<Root_d96a4c5c90cb64275ce1b63132467648/>
</RadixThemesBox>
</RadixThemesBox>
...
export default function Component() {
  ...
  return (
    <Errorboundary_2e2602e2f7ba03eac0fee461bf67b16c/>
  )
}
