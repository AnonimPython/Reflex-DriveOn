...
export function Root_da9fbd41f0bb3f21c9ef9d16df794763 () {
  ...
  const ref_confirm_password = useRef(null); refs["ref_confirm_password"] = ref_confirm_password;
    ...
    const handleSubmit_dd7ad0bc4e8394e1cb4e5f5161cf70c1 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["password"] : getRefValue(refs["ref_password"]), ["username"] : getRefValue(refs["ref_username"]), ["confirm_password"] : getRefValue(refs["ref_confirm_password"]), ["mail"] : getRefValue(refs["ref_mail"]) })};
  ...
  return (
    <RadixFormRoot className={"Root "} css={({ ["width"] : "100%", ["margin-top"] : "10%" })} onSubmit={handleSubmit_dd7ad0bc4e8394e1cb4e5f5161cf70c1}>
...
export function Errorboundary_1c292dc811b4a3395908750a9f454403 () {
...
<Root_da9fbd41f0bb3f21c9ef9d16df794763/>
</RadixThemesBox>
</RadixThemesBox>
...
export default function Component() {
  ...
  return (
    <Errorboundary_1c292dc811b4a3395908750a9f454403/>
  )
}
