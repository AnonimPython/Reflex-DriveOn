...
export function Root_f2e8fcc0bfb55d283dee7eae71ffab85 () {
  ...
  const ref_confirm_password = useRef(null); refs["ref_confirm_password"] = ref_confirm_password;
    ...
    const handleSubmit_2e1e95a14a08b7a99fdd0c0ea834fe65 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["username"] : getRefValue(refs["ref_username"]), ["phone"] : getRefValue(refs["ref_phone"]), ["confirm_password"] : getRefValue(refs["ref_confirm_password"]), ["mail"] : getRefValue(refs["ref_mail"]), ["password"] : getRefValue(refs["ref_password"]) })};
  ...
  return (
    <RadixFormRoot className={"Root "} css={({ ["width"] : "100%", ["margin-top"] : "10%" })} onSubmit={handleSubmit_2e1e95a14a08b7a99fdd0c0ea834fe65}>
...
export function Errorboundary_b7d4738ae4480431a623f23e8d8cd745 () {
...
<Root_f2e8fcc0bfb55d283dee7eae71ffab85/>
</RadixThemesBox>
</RadixThemesBox>
...
export default function Component() {
  ...
  return (
    <Errorboundary_b7d4738ae4480431a623f23e8d8cd745/>
  )
}
