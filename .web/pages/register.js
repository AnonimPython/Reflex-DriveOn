...
export function Root_4a4d27aba7b2c0df82374b737828166a () {
  ...
  const ref_confirm_password = useRef(null); refs["ref_confirm_password"] = ref_confirm_password;
    ...
    const handleSubmit_8a2c8da5975b3fa8178e976b9c8099c1 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["username"] : getRefValue(refs["ref_username"]), ["confirm_password"] : getRefValue(refs["ref_confirm_password"]), ["phone"] : getRefValue(refs["ref_phone"]), ["mail"] : getRefValue(refs["ref_mail"]), ["password"] : getRefValue(refs["ref_password"]) })};
  ...
  return (
    <RadixFormRoot className={"Root "} css={({ ["width"] : "100%", ["margin-top"] : "10%" })} onSubmit={handleSubmit_8a2c8da5975b3fa8178e976b9c8099c1}>
...
export function Errorboundary_d47f173019c5f0b87345558493ac23ec () {
...
<Root_4a4d27aba7b2c0df82374b737828166a/>
</RadixThemesBox>
</RadixThemesBox>
...
export default function Component() {
  ...
  return (
    <Errorboundary_d47f173019c5f0b87345558493ac23ec/>
  )
}
