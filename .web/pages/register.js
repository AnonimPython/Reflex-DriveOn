...
export function Root_6d1f3da5b8d8b802238e9d17e5acd9ba () {
  ...
  const ref_confirm_password = useRef(null); refs["ref_confirm_password"] = ref_confirm_password;
    ...
    const handleSubmit_8910fa16800f40e716c9cc9f830ce70f = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["mail"] : getRefValue(refs["ref_mail"]), ["phone"] : getRefValue(refs["ref_phone"]), ["username"] : getRefValue(refs["ref_username"]), ["confirm_password"] : getRefValue(refs["ref_confirm_password"]), ["password"] : getRefValue(refs["ref_password"]) })};
  ...
  return (
    <RadixFormRoot className={"Root "} css={({ ["width"] : "100%", ["margin-top"] : "10%" })} onSubmit={handleSubmit_8910fa16800f40e716c9cc9f830ce70f}>
...
export function Errorboundary_9ac342dc39b920050a8994568d4bb637 () {
...
<Root_6d1f3da5b8d8b802238e9d17e5acd9ba/>
</RadixThemesBox>
</RadixThemesBox>
...
export default function Component() {
  ...
  return (
    <Errorboundary_9ac342dc39b920050a8994568d4bb637/>
  )
}
