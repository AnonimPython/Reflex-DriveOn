...
export function Errorboundary_829860657c033bf72d7c9f329cdb91be () {
...
<Root_ce73ba7aaadc396463be0a4dfe10ac7c/>
</RadixThemesBox>
</RadixThemesBox>
...
export function Root_ce73ba7aaadc396463be0a4dfe10ac7c () {
  ...
  const ref_confirm_password = useRef(null); refs["ref_confirm_password"] = ref_confirm_password;
    ...
    const handleSubmit_99ecaacf4ccc51e061a3bfe87e70cd09 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["username"] : getRefValue(refs["ref_username"]), ["phone"] : getRefValue(refs["ref_phone"]), ["confirm_password"] : getRefValue(refs["ref_confirm_password"]), ["password"] : getRefValue(refs["ref_password"]), ["mail"] : getRefValue(refs["ref_mail"]) })};
  ...
  return (
    <RadixFormRoot className={"Root "} css={({ ["width"] : "100%", ["margin-top"] : "10%" })} onSubmit={handleSubmit_99ecaacf4ccc51e061a3bfe87e70cd09}>
...
export default function Component() {
  ...
  return (
    <Errorboundary_829860657c033bf72d7c9f329cdb91be/>
  )
}
