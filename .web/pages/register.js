...
export function Errorboundary_c1b0d13f9a8e26bd77e1dbba112bc6ec () {
...
<Root_c15cdd8c7521627f7f9ff11d4462fa2f/>
</RadixThemesBox>
</RadixThemesBox>
...
export function Root_c15cdd8c7521627f7f9ff11d4462fa2f () {
  ...
  const ref_confirm_password = useRef(null); refs["ref_confirm_password"] = ref_confirm_password;
    ...
    const handleSubmit_157b684e83abfc8e6d8ef39bc28de7e6 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["confirm_password"] : getRefValue(refs["ref_confirm_password"]), ["username"] : getRefValue(refs["ref_username"]), ["password"] : getRefValue(refs["ref_password"]), ["phone"] : getRefValue(refs["ref_phone"]), ["mail"] : getRefValue(refs["ref_mail"]) })};
  ...
  return (
    <RadixFormRoot className={"Root "} css={({ ["width"] : "100%", ["margin-top"] : "10%" })} onSubmit={handleSubmit_157b684e83abfc8e6d8ef39bc28de7e6}>
...
export default function Component() {
  ...
  return (
    <Errorboundary_c1b0d13f9a8e26bd77e1dbba112bc6ec/>
  )
}
