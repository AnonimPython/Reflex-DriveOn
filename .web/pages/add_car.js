...
export function Root_f70422b7c39437377320ab7759076c9b () {
  ...
  const ref_acceleration_to_100 = useRef(null); refs["ref_acceleration_to_100"] = ref_acceleration_to_100;
    ...
    const handleSubmit_3142b46d137ec13d29b6f4d9da2efe0b = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["doors"] : getRefValue(refs["ref_doors"]), ["car_width"] : getRefValue(refs["ref_car_width"]), ["seats"] : getRefValue(refs["ref_seats"]), ["image"] : getRefValue(refs["ref_image"]), ["car_length"] : getRefValue(refs["ref_car_length"]), ["company"] : getRefValue(refs["ref_company"]), ["price"] : getRefValue(refs["ref_price"]), ["acceleration_to_100"] : getRefValue(refs["ref_acceleration_to_100"]), ["car_height"] : getRefValue(refs["ref_car_height"]), ["horse_power"] : getRefValue(refs["ref_horse_power"]), ["car_model"] : getRefValue(refs["ref_car_model"]) })};
  ...
  return (
    <RadixFormRoot className={"Root "} css={({ ["width"] : "100%" })} onSubmit={handleSubmit_3142b46d137ec13d29b6f4d9da2efe0b}>
...
export function Errorboundary_3aa48b2711961d573c5f8fac500c865a () {
...
<Root_f70422b7c39437377320ab7759076c9b/>
...
export default function Component() {
  ...
  return (
    <Errorboundary_3aa48b2711961d573c5f8fac500c865a/>
  )
}
