...
export function Errorboundary_d369902df6faea34a2e102a21b267e75 () {
...
<Root_7a116fcc64acddf6f2296145ede79dac/>
...
export function Root_7a116fcc64acddf6f2296145ede79dac () {
  ...
  const ref_acceleration_to_100 = useRef(null); refs["ref_acceleration_to_100"] = ref_acceleration_to_100;
    ...
    const handleSubmit_a0174e9a2324ae99bf7acdf917b7725b = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["car_length"] : getRefValue(refs["ref_car_length"]), ["price"] : getRefValue(refs["ref_price"]), ["car_width"] : getRefValue(refs["ref_car_width"]), ["car_height"] : getRefValue(refs["ref_car_height"]), ["image"] : getRefValue(refs["ref_image"]), ["doors"] : getRefValue(refs["ref_doors"]), ["company"] : getRefValue(refs["ref_company"]), ["acceleration_to_100"] : getRefValue(refs["ref_acceleration_to_100"]), ["seats"] : getRefValue(refs["ref_seats"]), ["horse_power"] : getRefValue(refs["ref_horse_power"]), ["car_model"] : getRefValue(refs["ref_car_model"]) })};
  ...
  return (
    <RadixFormRoot className={"Root "} css={({ ["width"] : "100%" })} onSubmit={handleSubmit_a0174e9a2324ae99bf7acdf917b7725b}>
...
export default function Component() {
  ...
  return (
    <Errorboundary_d369902df6faea34a2e102a21b267e75/>
  )
}
