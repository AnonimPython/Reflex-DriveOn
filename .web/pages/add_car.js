...
export function Root_9118de61c1f7fb15b6cec7c4a0b49c50 () {
  ...
  const ref_acceleration_to_100 = useRef(null); refs["ref_acceleration_to_100"] = ref_acceleration_to_100;
    ...
    const handleSubmit_7438d976381316d7667b34734f1fe31e = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["car_model"] : getRefValue(refs["ref_car_model"]), ["image"] : getRefValue(refs["ref_image"]), ["company"] : getRefValue(refs["ref_company"]), ["doors"] : getRefValue(refs["ref_doors"]), ["car_width"] : getRefValue(refs["ref_car_width"]), ["horse_power"] : getRefValue(refs["ref_horse_power"]), ["seats"] : getRefValue(refs["ref_seats"]), ["price"] : getRefValue(refs["ref_price"]), ["acceleration_to_100"] : getRefValue(refs["ref_acceleration_to_100"]), ["car_length"] : getRefValue(refs["ref_car_length"]), ["car_height"] : getRefValue(refs["ref_car_height"]) })};
  ...
  return (
    <RadixFormRoot className={"Root "} css={({ ["width"] : "100%" })} onSubmit={handleSubmit_7438d976381316d7667b34734f1fe31e}>
...
export function Errorboundary_2c4a9739271b6cec3ace6dbffaf2a8ad () {
...
<Root_9118de61c1f7fb15b6cec7c4a0b49c50/>
...
export default function Component() {
  ...
  return (
    <Errorboundary_2c4a9739271b6cec3ace6dbffaf2a8ad/>
  )
}
