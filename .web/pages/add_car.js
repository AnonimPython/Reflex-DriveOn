...
export function Root_389958bb65e0ad7f4f6ec5f9e6df1628 () {
  ...
  const ref_acceleration_to_100 = useRef(null); refs["ref_acceleration_to_100"] = ref_acceleration_to_100;
    ...
    const handleSubmit_03415212b4492e80155a28ee9b81b57a = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["image"] : getRefValue(refs["ref_image"]), ["acceleration_to_100"] : getRefValue(refs["ref_acceleration_to_100"]), ["car_width"] : getRefValue(refs["ref_car_width"]), ["car_length"] : getRefValue(refs["ref_car_length"]), ["seats"] : getRefValue(refs["ref_seats"]), ["car_height"] : getRefValue(refs["ref_car_height"]), ["doors"] : getRefValue(refs["ref_doors"]), ["company"] : getRefValue(refs["ref_company"]), ["horse_power"] : getRefValue(refs["ref_horse_power"]), ["car_model"] : getRefValue(refs["ref_car_model"]), ["price"] : getRefValue(refs["ref_price"]) })};
  ...
  return (
    <RadixFormRoot className={"Root "} css={({ ["width"] : "100%" })} onSubmit={handleSubmit_03415212b4492e80155a28ee9b81b57a}>
...
export function Errorboundary_6658bf1362f8914c87a07772b8df1014 () {
...
<Root_389958bb65e0ad7f4f6ec5f9e6df1628/>
...
export default function Component() {
  ...
  return (
    <Errorboundary_6658bf1362f8914c87a07772b8df1014/>
  )
}
